...
>(({ className, children, indicatorPosition = "left", indicator, itemTextClassName, ...props }, ref) => (
  ...
  >
    <span
      className={cn(
        "pointer-events-none absolute z-10 flex h-3.5 w-3.5 items-center justify-center",
    ...
    <SelectPrimitive.ItemText className={itemTextClassName}>{children}</SelectPrimitive.ItemText>
  </SelectPrimitive.Item>
));
