...
export function generateWorkflowMessages(
  ...
  return [
    ...
    { stage: 2, type: "status", content: "正在解析输入材料...", timestamp: "", stepId: 2 },
    {
      stage: 2,
      type: "system",
      content: `已读取 ${brand} 的洞察报告与策划方案，提取品牌资产、市场趋势与用户画像`,
      timestamp: "",
      stepId: 2,
    },
    {
      stage: 2,
      type: "system",
      content: "输入材料解析完成，三层结构已建立，请在右侧确认解析结果",
      timestamp: "",
      stepId: 2,
    },
    {
